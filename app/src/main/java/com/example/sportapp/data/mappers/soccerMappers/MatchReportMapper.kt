...
import com.example.sportapp.CleanArchitexture.data.dto.match.EventDto
import com.example.sportapp.CleanArchitexture.domain.models.match.EventEntity
import com.example.sportapp.CleanArchitexture.domain.models.match.ReplacementEntity

class MatchReportMapper {

    fun getMatchEventsList(matchEvents: List<EventDto>): List<EventEntity> {

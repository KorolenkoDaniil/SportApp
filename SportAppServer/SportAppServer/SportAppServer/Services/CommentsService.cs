...
namespace SportAppServer.Services
{
...

    {
        ...
        //public async Task<CommentsPagination> GetPaginatedNewsListWithSearch(DateTime itemId, string Viewer, string searchPrompt, int pageNumber = 1, int pageSize = 10)
        //{
        //    List<CommentDTO> commmentsList = CommentMapper.ConvertToListOfDTO(await _commentRepository.GetPaginatedCommentsListWithSearch (itemId, pageNumber, pageSize));
        ...
        //public async Task<List<NewsDTO>> SearchNews(string searchPrompt)
        //{
        //    return NewsMapper.ConvertToListOfDTO( await _commentRepository.SearchNews(searchPrompt));
        //}
    }
}
